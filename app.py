...
def main():
    ...
    # Sistema de navegação SIMPLIFICADO - sem query_params
    if 'pagina_atual' not in st.session_state:
        st.session_state.pagina_atual = 'inicio'
    
    # Verificar qual página mostrar
    if st.session_state.pagina_atual == 'convencional':
