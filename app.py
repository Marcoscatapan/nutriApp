...
def main():
    ...
    with col1:
        ...
        st.markdown("""
        <div class="option-card option-card-convencional clickable-card" onclick="window.location.href='?page=convencional'">
            <div class="option-icon">🥗</div>
            <div class="option-title">Nutrição Convencional</div>
    ...
    with col2:
        ...
        st.markdown("""
        <div class="option-card option-card-triatlo clickable-card" onclick="window.location.href='?page=triatlo'">
            <div class="option-icon">🏊‍♂️🚴‍♂️🏃‍♂️</div>
            <div class="option-title">Nutrição para Triatletas</div>
            <div class="option-description">
